...
<html lang="en">
                  ...
                  <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                     <div class="full">
                        <div class="center-desk">
                           <div class="logo">
                               <a href="index.html"><img style="width: 100px; height: 50px;" src="./resources/images/logo.png" alt="#" /></a>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item">
                               ...
                               <li class="nav-link">
    <a href="#" onclick="toggleSubMenu('submenu1')">Danh mục</a>
  </li>
  <ul class="submenu" id="submenu1">
      <c:forEach items="${datacate}" var="v">
    <li class="submenu-item"><a tabindex="-1" href="category?id_category=<c:out value="${v.idCategory}"/>">${v.nameCategory}</a></li>
    </c:forEach>
            ...
            <div style="align-items: center;justify-content: center;" class="row">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                  <div class="glasses_box">
                     ...
                     <figure><img src="./resources/image/<c:out value="${c.image}"/>" alt="#"/></figure>
  ...
  function toggleSubMenu(submenuId) {
    ...
    if (submenu.style.maxHeight) {
      ...
      submenu.style.backgroundColor = "#ddd";
    } else {
      submenu.style.maxHeight = submenu.scrollHeight + "px";
      submenu.style.backgroundColor = white; /* Màu nền khi submenu mở ra */
    }
  }
</script>
