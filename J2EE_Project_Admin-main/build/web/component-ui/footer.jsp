<%-- 
    Document   : footer
    Created on : Nov 28, 2023, 3:24:35 PM
    Author     : Thanhchan
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <footer class="footer spad">
    ...
    <script src="resources/js2/jquery.nice-select.min.js"></script>
    <script src="resources/js2/jquery-ui.min.js"></script>
    <script src="resources/js2/jquery.slicknav.js"></script>
    <script src="resources/js2/mixitup.min.js"></script>
